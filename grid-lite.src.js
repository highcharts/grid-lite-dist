...
// UNUSED EXPORTS: AST, ColumnResizing, DataConnector, DataConverter, DataCursor, DataModifier, DataPool, DataTable, Grid, Pagination, SvgIcons, Table, Templating, defaultOptions, grid, grids, isHighContrastModeActive, merge, product, setOptions, version, win
 ...
 *
 * */
/* harmony default export */ const CreditsLiteComposition = ({
    compose
});
...
const { defaultOptions: grid_lite_src_defaultOptions, Grid: grid_lite_src_Grid, grid, grids, isHighContrastModeActive: grid_lite_src_isHighContrastModeActive, merge: grid_lite_src_merge, product, setOptions: grid_lite_src_setOptions, version: grid_lite_src_version, win: grid_lite_src_win } = G;
