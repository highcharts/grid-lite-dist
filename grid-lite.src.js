...
function compose(GridClass, TableClass) {
    if (!pushUnique(Core_Globals.composed, 'CreditsLite')) {
        return;
    }
 ...
 *
 */
function ResponsiveComposition_compose(GridClass) {
...
/* harmony default export */ const ResponsiveComposition = ({
    compose: ResponsiveComposition_compose
});
...
const { defaultOptions: grid_lite_src_defaultOptions, grid, grids, isHighContrastModeActive: grid_lite_src_isHighContrastModeActive, product, setOptions: grid_lite_src_setOptions, version: grid_lite_src_version, win: grid_lite_src_win } = G;
