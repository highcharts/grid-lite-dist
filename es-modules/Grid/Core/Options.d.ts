...
import type { CellContextMenuOptions } from './Table/CellContextMenu/CellContextMenuOptions';
 ...
 */
export type CellValueGetterCallback = (this: TableCell, cell: TableCell) => (DataTableCellType | Promise<DataTableCellType>);
/**
 * Callback function to be called when a header event is triggered. Returns a
...
export interface LangOptions extends LangOptionsCore {
     ...
     */
    columnFilteringOperators?: Partial<Record<ColumnFilteringCondition, string>>;
    /**
     ...
     */
    columnFilteringDateTimeOperators?: Partial<Record<ColumnFilteringCondition, string>>;
    /**
     ...
     */
    columnFilteringConditions?: Partial<Record<ColumnFilteringCondition, string>>;
    /**
