...
export declare const defaultOptions: import("../Shared/Types.js").DeepPartial<_Options>, grid: typeof _Grid.grid, grids: (_Grid | undefined)[], isHighContrastModeActive: () => boolean, product: string, setOptions: typeof import("../Grid/Core/Defaults.js").setOptions, version: "2.3.1", win: Window & typeof globalThis;
declare namespace G {
