...
export declare const defaultOptions: import("./es-modules/Shared/Types.js").DeepPartial<_Options>, Grid: typeof _Grid, grid: typeof _Grid.grid, grids: (_Grid | undefined)[], isHighContrastModeActive: () => boolean, merge: {
    <T = object>(extend: true, a?: T, ...n: Array<import("./es-modules/Shared/Types.js").DeepPartial<T> | undefined>): (T);
    <T1 extends object = object, T2 = unknown, T3 = unknown, T4 = unknown, T5 = unknown, T6 = unknown, T7 = unknown, T8 = unknown, T9 = unknown>(a?: T1, b?: T2, c?: T3, d?: T4, e?: T5, f?: T6, g?: T7, h?: T8, i?: T9): (T1 & T2 & T3 & T4 & T5 & T6 & T7 & T8 & T9);
}, product: string, setOptions: typeof import("./es-modules/Grid/Core/Defaults.js").setOptions, version: "2.1.0", win: Window & typeof globalThis;
declare namespace G {
